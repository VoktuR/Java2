public class Main {
    ...
    static long timer;
    static boolean isFirstThreadFinished = false;
    static boolean isSecondThreadFinished = false;
    ...
    static synchronized void calculateArrayUsingThreads() {
        ...
        while (!isFirstThreadFinished && !isSecondThreadFinished) {
            try {
