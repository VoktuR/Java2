public class SingleLinkedList implements SingleList {
    private Node first;
    private int size = 0;
...
//        return i;
    ...
    @Override
    public SingleIterator iterator() {
    ...
    public static class StraightForwardIterator implements SingleIterator {
